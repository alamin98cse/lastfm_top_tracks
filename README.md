...
1. Setup
    ...
    -  Required package **[integration/lastfm](https://packagist.org/packages/integration/lastfm)** . 'composer update' command will take care it as this package already included in composer.json.
    - make sure the DocumentRoot is "~/lastfm/public". 
